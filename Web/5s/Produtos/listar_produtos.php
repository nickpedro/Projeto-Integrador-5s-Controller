...
<table class="table" id="emp_table" border="0">
            ...
            $sql = "SELECT COUNT(*) AS cntrows FROM tbestoque";
            $result = mysqli_query($conexao,$sql);
            $fetchresult = mysqli_fetch_array($result);
            $allcount = $fetchresult['cntrows'];

            // selecting rows
            $sql = "SELECT * FROM tbestoque  ORDER BY ID ASC limit $row,".$rowperpage;
            $result = mysqli_query($conexao,$sql);
            $sno = $row + 1;
        ...
        $valor = $fetch['valor'];
        $qtProd = $quantidade * $valor;
        $qtProd1 = number_format($qtProd, 2);
                ?>
                <tr>
            ...
            if ($quantidade < 10) { 
             $cor = "color:red";
              ...
              $cor = "color:green";
            } echo "<span style=$cor>".$quantidade."</span>" ?></td>
            <td><?php echo $valor ?></td>
            <td><?php echo $qtProd1 ?></td>
                </tr>
            <?php
                $sno ++;
            }
...
<form action="_inserir_tipo_prod.php" method="post">
    <div class="form-group">
        <label>Produto</label>
        <input type="text" name="Produto" class="form-control" autocomplete="off">
        <label>Preço</label>

...
<form action="_inserir_fut_entrega.php" method="post" style="margin-top: 20px;">
...
<label for="exampleFormControlSelect1">Fornecedor</label>
                ...
                <?php
                    include '../Entregas/conexao.php';
                    $sql = "SELECT * FROM tbestoque order by Nome ASC";
                    $buscar = mysqli_query($conexao, $sql);
                    ...
                    <?php } ?>
                            ...
                            <label for="exampleInputEmail1">Quando</label>
                    <input id="datepicker" width="276" name="data">
                    <br><br><br>
                    <script>
        $('#datepicker').datepicker({ format: 'yyyy-mm-dd' });
            ...
            <div class="form-group">
                <label>Quantidade Fardo</label>
                <input type="number" class="form-control" name="quantidadeFardo" placeholder="Insira a quantidade de Produto" autocomplete = "off">
            </div>

            <div class="form-group">
                <label>Quantidade Unidade</label>
                <input type="number" class="form-control" name="quantidadeUnidade" placeholder="Insira a quantidade de Produto" autocomplete = "off">
            </div>
